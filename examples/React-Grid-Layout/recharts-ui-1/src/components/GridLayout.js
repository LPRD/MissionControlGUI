...
class GridLayout extends Component {
  ...
  render() {
    ...
    // console.log("GridLayout.js render props", this.props);
    // console.log("GridLayout.js layouts", layouts);
    return (
      <ResponsiveGridLayout
        ...
        preventCollision={true}   //disable other grid items from being relocated 
